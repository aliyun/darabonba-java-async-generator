...
class BuilderGenerator extends CommonGenerator {
  ...
  codegen(level = 0) {
    this.emitln(`public static final class Builder${this.ctx.isRequestModel ? ' extends Request.Builder<' + this.realModelName + '.Builder>' : this.ctx.isResponseModel ? ' extends Response.Builder' : ''} {`, level);
