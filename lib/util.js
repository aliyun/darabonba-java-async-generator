...
function _subModelName(name, conflictModelNameMap, allModleNameMap) {
  ...
  // Request/Response shadow gateway.pop.models.Request|Response when nested
  // inside *Request/*Response models (extendsPackage import), which breaks
  // `extends Request.Builder<...>` compilation.
  const keywords = ['Body', 'Header',
    'Host', 'Path', 'Query', 'EnumType', 'NameInmap',
    'ParentIgnore', 'Validate', 'Request', 'Response'];
